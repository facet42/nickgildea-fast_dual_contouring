...
namespace Facet42
{
    internal static class Qef
    {
        ...
        private static void SvdSolveATAATb(Mat4x4 ATA, Vector4 ATb, out Vector4 x)
        {
            var V = new Mat4x4(
                1f, 0, 0, 0,
                0, 1f, 0, 0,
        ...
        private static Vector4 SvdSolveSym(ref Mat4x4 v, Mat4x4 a)
        {
            var vtav = a;
        ...
        private static void SvdPseudoInverse(out Mat4x4 o, Vector4 sigma, Mat4x4 v)
        {
        ...
        private static Vector4 SvdInvDet(Vector4 v)
        {
